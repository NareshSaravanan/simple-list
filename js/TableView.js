      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          <select class="form-control" id="sort-select">
              <option value="title:asc" <%= isSelected("title:asc") %>>Sort by Title : ASC</option>
              <option value="title:desc" <%= isSelected("title:desc") %>>Sort by Title : DESC</option>
              <option value="lastModified:asc" <%= isSelected("lastModified:asc") %>>Sort by Modified Date : ASC</option>
              <option value="lastModified:desc" <%= isSelected("lastModified:desc") %>>Sort by Modified Date : DESC</option>
          </select>
          </div>
      </div>
    </header>
